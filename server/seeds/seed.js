...
const hotels = [
  ...
  },
  {
    ...
    description: "A floating ryokan accessible only by boat, where traditional Japanese hospitality meets modern luxury along the Oi River in Arashiyama.",
    location: { city: "Kyoto", country: "Japan", address: "Arashiyama Genrokuzancho, Nishikyo-ku, Kyoto 616-0007" },
    coordinates: { lat: 35.0116, lng: 135.6617 },
    stars: 5,
    rating: 9.5,
    reviewCount: 654,
    pricePerNight: 785,
    ...
    amenities: ["Kaiseki Dining", "Spa", "River Views", "Traditional Activities", "Boat Access", "Concierge"],
    propertyType: "resort",
    featured: false,
    highlights: ["Boat Access Only", "Riverside Setting", "Traditional Ryokan"],
    rooms: [
      { name: "Tsuki Room", capacity: 2, beds: "Japanese Futon", price: 785, available: true },
      { name: "Hoshi Room", capacity: 3, beds: "Japanese Futon", price: 1050, available: true },
      { name: "Yama Room", capacity: 4, beds: "Japanese Futon", price: 1450, available: true }
    ]
  },
  // Marrakech
  {
    name: "Royal Mansour Marrakech",
    description: "An extraordinary palace hotel where each accommodation is a private riad with rooftop terrace, plunge pool, and butler access via underground tunnels.",
    location: { city: "Marrakech", country: "Morocco", address: "Rue Abou Abbas El Sebti, Marrakech 40000" },
    coordinates: { lat: 31.6258, lng: -8.0137 },
    stars: 5,
    rating: 9.8,
    reviewCount: 876,
    pricePerNight: 1250,
    ...
    amenities: ["Spa", "Multiple Pools", "Fine Dining", "Private Riads", "Butler Service", "Gardens", "Concierge"],
    propertyType: "hotel",
    featured: true,
    highlights: ["Private Riads", "3 Michelin Stars", "Underground Passages"],
    rooms: [
      { name: "Premier Riad", capacity: 2, beds: "1 King", price: 1250, available: true },
      { name: "Superior Riad", capacity: 4, beds: "2 King", price: 2200, available: true },
      { name: "Grand Riad", capacity: 6, beds: "3 King", price: 4500, available: true }
    ]
  },
  // Vienna
  {
    name: "Hotel Sacher Wien",
    description: "Home of the original Sachertorte, this legendary Viennese hotel opposite the State Opera has been the epitome of Austrian elegance since 1876.",
    location: { city: "Vienna", country: "Austria", address: "Philharmoniker Str. 4, 1010 Wien" },
    coordinates: { lat: 48.2039, lng: 16.3695 },
    stars: 5,
    rating: 9.4,
    reviewCount: 2345,
    pricePerNight: 485,
    ...
    amenities: ["Spa", "Fine Dining", "Cafe Sacher", "Bar", "Concierge", "Fitness Center", "Free WiFi"],
    propertyType: "hotel",
    featured: false,
    highlights: ["Original Sachertorte", "Opera Views", "Imperial History"],
    rooms: [
      { name: "Sacher Room", capacity: 2, beds: "1 King", price: 485, available: true },
      { name: "Opera Suite", capacity: 3, beds: "1 King + Sofa", price: 895, available: true },
      { name: "Presidential Suite", capacity: 4, beds: "2 King", price: 2500, available: true }
    ]
  },
  // Reykjavik
  {
  ...
  // Buenos Aires
  {
    ...
    description: "The most prestigious address in Buenos Aires, this French neoclassical palace in Recoleta has hosted royalty, celebrities, and heads of state since 1932.",
    location: { city: "Buenos Aires", country: "Argentina", address: "Av. Alvear 1891, C1129AAA Buenos Aires" },
    ...
    amenities: ["Spa", "Pool", "Fine Dining", "Butler Service", "Concierge", "Fitness Center", "Free WiFi"],
    propertyType: "hotel",
    featured: false,
    highlights: ["Recoleta Location", "French Palace", "Butler Service"],
    rooms: [
      { name: "Deluxe Room", capacity: 2, beds: "1 King", price: 385, available: true },
      { name: "Executive Suite", capacity: 3, beds: "1 King + Sofa", price: 685, available: true },
      { name: "Royal Suite", capacity: 4, beds: "2 King", price: 1850, available: true }
    ]
  },
  // Additional budget/mid-range options for variety
  {
